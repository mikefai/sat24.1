...
import json
import os
from gen_test4_rw1 import rw1
from gen_test4_rw2 import rw2
from gen_test4_math import math1, math2
...
test4 = {
    "id": "test-4",
    "title": "SAT Practice Test 4 (2026 Edition)",
...
out_path = os.path.join("src", "data", "test4.js")
with open(out_path, "w", encoding="utf-8") as f:
    f.write("// Digital SAT 2026 Practice Test 4\n")
    f.write("export const test4 = ")
    json.dump(test4, f, indent=2, ensure_ascii=False)
    f.write(";\n")

print(f"Successfully generated Test 4: {out_path} with 108 questions!")
